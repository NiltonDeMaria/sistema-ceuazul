...
function Update() {
    ...
    const updateAPIData = () => {
        axios.put(`https://63c5cfbdf80fabd877f05d4d.mockapi.io/projetom3/${id}`, {
            nomeResp,
            naturalResp,
            email,
            celular,
                    ...
                    <FormControl display="flex" flexDir="column" gap="4">
                        <HStack spacing="4">
                            <Box w="100%">
                                ...
                                <Input id="nome" type="text" value={nomeResp} onChange={(e) => setNomeResp(e.target.value)} />
                            </Box>
                            <Box w="100%">
                                <FormLabel htmlFor="natural">Naturalidade</FormLabel>
                                <Input id="natural" type="text" value={naturalResp} onChange={(e) => setNaturalResp(e.target.value)} />
                            </Box>
                        </HStack>
                        <HStack spacing="4">
                            <Box w="100%">
                        ...
                        <HStack spacing="4">
                            <Box w="100%">
                                ...
                                <Input id="cel" type="number" value={celular} onChange={(e) => setCelular(e.target.value)} />
                            </Box>
                            <Box w="100%">
                                <FormLabel htmlFor="Tefone">Telefone</FormLabel>
                                <Input id="Tefone" type="number" value={telefone} onChange={(e) => setTelefone(e.target.value)} />
                            </Box>
                        </HStack>
                        <HStack spacing="4">
                            <Box w="100%">
                        ...
                        <HStack spacing="4">
                            <Box w="100%">
                                ...
                                <Input id="nomeC" type="text" value={nomeCrian} onChange={(e) => setNomeCrian(e.target.value)} />
                            </Box>
                            <Box w="100%">
                                <FormLabel htmlFor="natural">Naturalidade</FormLabel>
                                <Input id="naturalC" type="text" value={naturalCrian} onChange={(e) => setNaturalCrian(e.target.value)} />
                            </Box>
                        </HStack>
                        <HStack>
                            <Box w="100%">
                            ...
                            <Box w="100%">
                                ...
                                <Input id="ts" type="text" value={tipoSang} onChange={(e) => setTipoSang(e.target.value)} />
                            </Box>
                        </HStack>
                        <HStack spacing="4">
                            <Box w="100%">
